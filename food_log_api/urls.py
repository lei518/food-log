...
urlpatterns = [
    ...
    path('remove-food/<int:food_id>/', views.remove_food, name='remove-food'),
    ...
    path('edit-hydration/<int:hydration_id>/', views.edit_hydration, name='edit-hydration'),
    ...
    path('remove-hydration/<int:hydration_id>/', views.remove_hydration, name='remove-hydration'),
